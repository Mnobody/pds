...
final class TextComparator
{
    ...
    public function __construct(private readonly SimilarityFormatter $formatter)
    {
    }

    public function compare(array $first, array $second): int
    {
        ...
        return $this->formatter->percentage($similarity);
    }
